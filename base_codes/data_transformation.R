...
full.dat=read.csv("antibody/data_bin/AUC_by_isotype.csv")
...
dat=subset(full.dat,full.dat$day==7)
  ...
  write.csv(dat.7,file=paste("antibody/data_bin/d7/dat.7.auc.csv",sep=""),row.names=F)
...
dat=subset(full.dat,full.dat$day==10)
  ...
  write.csv(dat.10,file=paste("antibody/data_bin/d10/dat.10.auc.csv",sep=""),row.names=F)
...
dat=subset(full.dat,full.dat$day==15)
  ...
  write.csv(dat.15,paste("antibody/data_bin/d15/dat.15.auc.csv",sep=""),row.names=F)         
...
dat=subset(full.dat,full.dat$day==45)
  ...
  write.csv(dat.45,file=paste("antibody/data_bin/d45/dat.45.auc.csv",sep=""),row.names=F)
